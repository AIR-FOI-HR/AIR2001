...
$select = "select * from recenzija where id_proizvod in(select id_proizvod from pivo_lokacija where id_lokacija = $id_lokacija) order by datum_i_vrijeme_recenzije DESC limit 2";
