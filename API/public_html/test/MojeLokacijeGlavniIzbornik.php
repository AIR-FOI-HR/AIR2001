...
$query = mysqli_query($con,"SELECT l.id_lokacija, l.naziv_lokacije, CAST(AVG(r.ocjena) AS DECIMAL(10,2)) AS prosjek, l.adresa_lokacije FROM lokacija l left JOIN recenzija r on l.id_lokacija = r.id_lokacija JOIN omiljena_lokacija o on l.id_lokacija = o.lokacija_id_lokacija WHERE o.korisnik_id_korisnik = $idKorisnik LIMIT 2");
