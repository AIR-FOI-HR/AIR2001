...
$select = "SELECT l.naziv_lokacije, l.adresa_lokacije, CAST(AVG(r.ocjena) AS DECIMAL(10,2)),l.id_lokacija FROM lokacija l LEFT JOIN recenzija r on r.id_lokacija = l.id_lokacija WHERE l.naziv_lokacije LIKE '%$pretrazivanje%'";
